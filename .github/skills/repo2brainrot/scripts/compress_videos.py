...
Usage:
    python compress_videos.py output/my-repo/videos/
    python compress_videos.py output/my-repo/videos/ --crf 30 --width 720
    python compress_videos.py output/my-repo/videos/ --dry-run
"""
